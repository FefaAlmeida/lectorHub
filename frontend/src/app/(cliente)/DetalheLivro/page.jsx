      ...
      >
        <VStack spacing={8} align="stretch" h="full">
          <HStack spacing={3} px={2}>
            ...
            <Box>
              <Heading fontSize="md" color="gray.900" fontFamily="serif">Minha Biblioteca</Heading>
          ...
          <VStack as="nav" spacing={1} align="stretch">
            {NAV_ITEMS.map((item) => (
              <Button
                ...
                borderRadius="6px"
                _hover={{ bg: "rgba(122, 49, 49, 0.04)", color: ACCENT }}
        ...
        <Container maxW="6xl" px={0}>
          <FadeIn>
            <Button
              ...
              mb={6}
              color="gray.600"
              _hover={{ color: ACCENT, bg: "rgba(122, 49, 49, 0.05)" }}
            ...
            <SimpleGrid columns={{ base: 1, lg: 3 }} spacing={8}>
                ...
                <VStack spacing={8} align="stretch">
                  ...
                  >
                    ...
                    <VStack align="flex-start" spacing={4} flex={1}>
                      ...
                      <Heading fontSize="3xl" fontFamily="Georgia, serif" color="gray.900">
                        {book.title}
                      </Heading>
                      ...
                      <HStack spacing={2}>
                        {book.categories?.map((cat, i) => (
                          <Tag.Root key={i} bg="#F3ECE6" color={ACCENT} borderRadius="md" size="sm">
                            {cat}
                          </Tag.Root>
                        ))}
                      </HStack>
                    ...
                    {[
                      ...
                      <Box key={i} bg="#FAF9F6" p={4} borderRadius="12px" border="1px solid" borderColor="#EFEBE3">
                        <VStack align="flex-start" spacing={1}>
                          ...
                          <Text fontSize="sm" fontWeight="semibold" color="gray.800">{item.val}</Text>
                        </VStack>
                      </Box>
                    ))}
                  </SimpleGrid>
                  ...
                  <Box bg="#FAF9F6" p={6} borderRadius="16px" border="1px solid" borderColor="#EFEBE3">
                    <Flex justify="space-between" align="center" mb={6}>
                      <Heading fontSize="lg" fontFamily="Georgia, serif">Avaliações dos leitores</Heading>
                      <Button variant="link" color={ACCENT} fontSize="sm">
                        Ver todas ({book.totalReviews}) →
                      </Button>
                    </Flex>

                    <Flex direction={{ base: "column", sm: "row" }} gap={8} align="center">
                      <VStack spacing={1} align="center">
                        <Text fontSize="4xl" fontWeight="bold" color="gray.900" fontFamily="serif">
                          {book.ratingAverage}
                        </Text>
              ...
              <VStack spacing={6} align="stretch">
                <Box bg="#FAF9F6" p={6} borderRadius="16px" border="1px solid" borderColor="#EFEBE3">
                  <Heading fontSize="md" fontFamily="Georgia, serif" mb={4} color="gray.900">
                  ...
                  <VStack spacing={3} mt={6} pt={6} borderTop="1px solid" borderColor="#EFEBE3" align="stretch">
                    {[
                      ...
                      { icon: FiMapPin, label: "Localização", val: book.location },
                ...
                <Box bg="#FAF9F6" p={6} borderRadius="16px" border="1px solid" borderColor="#EFEBE3">
                  <Flex justify="space-between" align="center" mb={4}>
                    <Heading fontSize="sm" fontFamily="Georgia, serif">Livros semelhantes</Heading>
